...
class JointWebqaParameters:
    def __init__(self, dev, train_idx=None, epoch =39):
        ...
        self.emb_dim = 300
        #q_hidden, rel_hidden = 50, 100,150,200, default:150
        self.q_hidden = 150
        self.rel_hidden = 150

        #merge_fts_dim 100, 150, 200, 250 default:100
        self.merge_fts_dim = 100

        # self.sru_ly_num 1, 2, default:1
        self.sru_ly_num = 1
        ...
        self.with_selection = True  #default:True
        self.without_interactive = False

        self.dropout_liner_output_rate = 0.1 #default =0.25
